...
class Post(models.Model):
    ...
    post_date = models.TextField(null=True,blank=True)
    ...
    app_begin_date =models.TextField()
    app_last_date =models.TextField()
    app_last_fees_date=models.TextField(null=True,blank=True)
    exam_date=models.TextField(null=True,blank=True)
    prelim_exam_date=models.TextField(null=True,blank=True)
    main_exam_date=models.TextField(null=True,blank=True)
    interview_exam_date=models.TextField(null=True,blank=True)
    result_exam_date=models.TextField(null=True,blank=True)
